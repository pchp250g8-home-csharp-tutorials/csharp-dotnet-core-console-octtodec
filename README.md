OctToDec. C# Tutorials. Simple Input/Output. Strings. Algorithms. DotNet Core Platform. Console Application. 
...
OctToDec. Занятия по С#. Простой ввод/вывод. Строки. Алгоритмы. Платформа DotNet Core. Консольное приложение.
